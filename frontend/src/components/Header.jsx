    ...
    return (
        <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20">
            ...
            <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 md:py-[10vw] md:mb-[-30px] m-auto">
                <p className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight md:leading-tight">Book Appointment <br /> With Trusted Doctors</p>
